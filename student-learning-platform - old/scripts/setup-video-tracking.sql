-- Create tables for video tracking and course progress
...
-- User profile status
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS total_videos_watched INTEGER DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS total_quizzes_passed INTEGER DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS average_focus_score NUMERIC(5,2) DEFAULT 0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS average_posture_score NUMERIC(5,2) DEFAULT 0;
